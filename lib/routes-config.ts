...
export const ROUTES: EachRoute[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "5: Best React", href: "/workshop-5" },
      { title: "6: Backend Basics", href: "/workshop-6" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "5: Code Improvements", href: "/assignment-5" },
      { title: "6: Basic API", href: "/assignment-6" },
      { title: "7: Supabase", href: "/assignment-7" },
      { title: "8: Deploy & Bonus Feature", href: "/assignment-8" },
      { title: "9: Final Project Completion", href: "/assignment-9" },
    ],
  },
];
